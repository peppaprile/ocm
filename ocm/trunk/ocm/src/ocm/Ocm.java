...
public class Ocm implements PacketListener {
  private static String SmackSvrIP="";
   private static String AsteriskSvrIP=""; 
...
Collection<RosterGroup>  groups;
  ...
  //  private final String SmackSvrIP = "10.60.34.44";
  //  private final String AsteriskSvrIP = "10.60.34.44"; 
  //  private final String SmackSvrName = "itctapx1f.intra.acer-euro.com";
    ...
    public void processPacket(Packet packet) 
    {
        ...
        if(packet.getClass() == Presence.class)
        {
           ...
           //  mylog.info(p.getStatus().toString());
            if(isDebugOn)
            {
        ...
        public void run() 
        {
                ...
                if(PresenceList.get(to)!=null){
                    ...
                    if(p.contentEquals("available")){
                        System.out.println("send alert at app time because not avalaible 5 min before"+this.to);
    ...
    class sendAlertMsg extends TimerTask 
    {
        ...
        {                 
            ...
            if(PresenceList.get(to)!=null){
                ...
                String p =  PresenceList.get(to).toString();
                System.out.println("send alert 5 min before"+this.to); 
                if(p.contentEquals("available")){
   ...
   private static SOAPMessage createSOAPRequest(String serverName, String hour, String minutes) throws Exception {
        ...
        for (Element response : elements(soapBody.getElementsByTagName("AppointmentList_reminderResponse"))) {
          for (Element result : elements(response.getElementsByTagName("AppointmentList_reminderResult"))) {
            ...
            for(int i=0;i< children.size();i++){
                ...
                String User_ID = (named(resultDataChildren.get(2), "User_ID").getTextContent());
                String User_Extension = (named(resultDataChildren.get(3), "User_Extension").getTextContent());
                String CustomerName = (named(resultDataChildren.get(4), "CustomerName").getTextContent());
                String Status = (named(resultDataChildren.get(5), "Status").getTextContent());
                String Appt = (named(resultDataChildren.get(6), "Appt").getTextContent());
                ...
                int nowseconds = cal.get(Calendar.SECOND);
                  ...
                  System.out.println(User_Extension);
    ...
    class QueryWS2 extends TimerTask 
    {
        public void run() 
        {
          ...
          // http://tloader-dev.emea.intra.acer.com/services/OCM.asmx?op=HourlyCaseCheck
            try {
            // Create SOAP Connection
            SOAPConnectionFactory soapConnectionFactory = SOAPConnectionFactory.newInstance();
            SOAPConnection soapConnection = soapConnectionFactory.createConnection();
            String url = "http://tloader-dev.emea.intra.acer.com/services/OCM.asmx";
    ...
    public void run() throws IOException,  TimeoutException, InterruptedException,   XMPPException
    {   
        CheckList cl= new CheckList();
        timer = new Timer();
        timer.schedule(cl, 0, 1800000);//15 m
        ...
        for(RosterGroup g:groups)
        {
            ...
            {    
                ...
                /*
                if(PresenceList.containsKey(r.getUser())){
                    PresenceList.put(r.getUser(), roster.getPresence(r.getUser()).getType());
                }else{
                    PresenceList.put(r.getUser(), roster.getPresence(r.getUser()).getType());
                }
        ...
        roster.addRosterListener(new RosterListener() {
            ...
            public void entriesUpdated(Collection<String> addresses) {
                for (Iterator iterator = addresses.iterator(); iterator.hasNext();) {
                    ...
                    String tempa[] = clctn0.split("/");
                    String agent = tempa[0];
                    PresenceList.put(agent, "undefined");
                }
            }
            ...
            public void presenceChanged(Presence presence) {
                   ...
                   PresenceList.put(agent, presence.getType());
            }
        });
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
           ...
           AsteriskSvrIP=InetAddress.getLocalHost().getHostAddress();
